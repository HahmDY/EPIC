...
# sparse vs viper
print("sparse vs viper")
pearson_coff = np.corrcoef(data['canon_reward'], data['canon_reward_viper'])[0,1]
#print(pearson_coff)
...
# step vs viper
print("step vs viper")
pearson_coff = np.corrcoef(data['canon_reward_step'], data['canon_reward_viper'])[0,1]
#print(pearson_coff)
pearson_dist = np.sqrt(1-pearson_coff) / np.sqrt(2)
print(pearson_dist)
